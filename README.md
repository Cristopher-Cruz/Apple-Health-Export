...
Extensible Markup Language (XML) is a markup language and file format used for storing and transmitting structured data. If you are unfamiliar with XML, I highly recommend taking a look at mozilla's [XML introduction](https://developer.mozilla.org/en-US/docs/Web/XML/XML_introduction).

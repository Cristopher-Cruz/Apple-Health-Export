...
Opening the file can be alarming as there are thousands of lines of data, but we can briefly browse the file to take a closer look at how the elements are stored. This will help us with knowing how to refer to the elements we want to extract later. Here our element of interest is the "Workout" element and its contents
